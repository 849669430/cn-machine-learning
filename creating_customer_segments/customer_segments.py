...
print("在测试集的预测得分：{:.2f}".format(score))
...
outliers  = [75,66,95,128,193,218,304,305,338,353,357,412,75,122,154,204,402,161,109,142,187,233,356,142,184]
...
# **回答:**
# 根据u减去2倍的方差和u加上2倍的方差数据应该相同，u加上2倍的方差接近最大值，那么u减去2倍的方差是否应该接近最小值呢，所以去除3以下的log值，特别log值为1的数
...
# **回答：**  
# 使用clster特征的得分要比不使用的更高，对我的启发是如果用聚类先把数据进行整理，再用监督学习的方法，会使数据分类更加好用。
