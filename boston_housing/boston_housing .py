...
# ### 问题 10 - 回答： 
# 1.从房屋特征数值来看不合理，贫困指数高价格很合理，不过学生比例相对多，应该选择占地面积大的房子，而社区贫困指数最低的却学生比例少的，房子却是最多的。
# 2.根据最大值和最小值，价格很合理，看到第一个客户应该属于中间的价格，很接近中值和平均值，而方差比均值小，和第三名客户接近，所以很合理
